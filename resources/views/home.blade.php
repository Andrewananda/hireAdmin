                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card-bx stacked card">
                            <img src="{{asset('assets/images/card/card1.jpg')}}" alt="">
                            <div class="card-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
                                    <div class="items">
                                        <div class="text-center">
                                            <img class="mb-3 rounded"
                                                 src="{{asset('assets/images/contacts/Untitled-1.jpg')}}" alt="">
                                    ...
                                    <div class="items">
                                        <div class="text-center">
                                            <img class="mb-3 rounded"
                                                 src="{{asset('assets/images/contacts/Untitled-2.jpg')}}" alt="">
                                    ...
                                    <div class="items">
                                        <div class="text-center">
                                            <img class="mb-3 rounded"
                                                 src="{{asset('assets/images/contacts/Untitled-3.jpg')}}" alt="">
                                    ...
                                    <div class="items">
                                        <div class="text-center">
                                            <img class="mb-3 rounded"
                                                 src="{{asset('assets/images/contacts/Untitled-4.jpg')}}" alt="">
                                    ...
                                    <div class="items">
                                        <div class="text-center">
                                            <img class="mb-3 rounded"
                                                 src="{{asset('assets/images/contacts/Untitled-5.jpg')}}" alt="">
